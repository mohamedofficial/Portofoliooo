...
export default function loadPosts() {
  // import all .md files from the posts folder as raw strings, eagerly
  // Vite replaces import.meta.glob at build-time
  ...
  // Sort by date descending when dates are present
  posts.sort((a, b) => {
